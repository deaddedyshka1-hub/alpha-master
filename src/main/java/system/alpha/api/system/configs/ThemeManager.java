...
import system.alpha.client.ui.theme.ThemeSelectable;
//.client.ui.theme.basic.*;
import system.alpha.client.ui.theme.basic.*;
...
public class ThemeManager {
    ...
    private void loadDefaultThemes() {
        Theme[] themes = new Theme[]{
                new Theme("Альфовская"),
                new BlueTheme().update(), new CandyLoveTheme().update(), new CrimsonTheme().update(),
                new OceanDepthsTheme().update(), new MidnightForestTheme().update(), new SolarFlareTheme().update(),
                new ArcticAuroraTheme().update(), new RoyalVelvetTheme().update()
        };
