...
@ModuleRegister(name = "Trails", category = Category.RENDER, description = "Рисует взади вас красивую линию.")
public class TrailsModule extends Module {
    @Getter private static final TrailsModule instance = new TrailsModule();

    private final SliderSetting length = new SliderSetting("Длина").value(1500f).range(500f, 3000f).step(100f);
    ...
    private final SliderSetting fadeTime = new SliderSetting("Время затухания").value(250f).range(100f, 1000f).step(50f);
