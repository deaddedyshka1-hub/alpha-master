...
@ModuleRegister(name = "Health Resolver", category = Category.OTHER, description = "Помогает распозновать хп игрока.")
public class HealthResolverModule extends Module {
    ...
    private final ModeSetting mode = new ModeSetting("Сервер").value("Fun Time").values("Really World", "Fun Time");
