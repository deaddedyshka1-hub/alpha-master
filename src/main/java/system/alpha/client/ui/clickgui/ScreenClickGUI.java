package system.alpha.client.ui.clickgui;
...
import system.alpha.client.ui.clickgui.module.ModuleComponent;
...
public class ScreenClickGUI extends Screen implements QuickImports {
    ...
    private ModuleComponent hoveredModule = null;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        for (Panel panel : panels) {
            ...
            for (ModuleComponent module : panel.getModuleComponents()) {
                if (module.showTooltip) {
        ...
        if (hoveredModule != null) {
            hoveredModule.renderTooltip(context, mouseX, mouseY);
        }
    }
