...
import system.alpha.api.event.events.other.WindowResizeEvent;
import system.alpha.api.system.configs.ThemeManager;
...
public class ThemeEditor extends UIComponent {
    ...
    private final Theme defaultTheme = new Theme("Альфовская");
